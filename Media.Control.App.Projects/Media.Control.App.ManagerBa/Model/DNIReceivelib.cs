    ...
    public class DNIReceivelib
    {
        ...
        public bool Start(string sourceName)
        {
            ...
            var recvSettings = new recv_create_v3_t()
            {
                ...
                color_format = recv_color_format_e.recv_color_format_e_RGBX_RGBA, 
            ...
            Task.Run(() => TaskReceive(Tokensource.Token));
            isRunning = true;
        ...
        private WriteableBitmap ConvertToWriteableBitmap(video_frame_v2_t frame)
        {
            ...
            {
                Debug.WriteLine($"Error converting to WriteableBitmap: {ex.Message}");
                return null;
            }
        }
