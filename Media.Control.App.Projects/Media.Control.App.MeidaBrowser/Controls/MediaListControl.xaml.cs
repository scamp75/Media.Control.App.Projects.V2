...
namespace Media.Control.App.MeidaBrowser.Controls
{
    ...
    public partial class MediaListControl : System.Windows.Controls.UserControl
    {
        ...
        public event EventHandler<object> ButtonMouseDoubleClicked;
        ...
        private void MediaView_List_PreviewMouseDoubleClick(object sender, MouseButtonEventArgs e)
        {
            ButtonMouseDoubleClicked?.Invoke(this, sender); // 부모 폼에 이벤트 전달
        }
    }
}
